...
class SimuladorGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  Q_OBJECT
  ...
  protected:
    ...
    GLuint VAO_Terra; // VAO específic per al terra
    ...
    float minY[NUM_MODELS];
    float minX[NUM_MODELS];
    float minZ[NUM_MODELS];
    /***********************************************/
    ...
    bool orto=true; // indica si la projecció és ortogràfica o perspectiva
