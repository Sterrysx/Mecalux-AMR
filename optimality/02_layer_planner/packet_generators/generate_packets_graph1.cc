...
void printUsage(const char* progname) {
    ...
    cerr << "  seed             : Random seed (optional, default: current time)" << endl;
    cerr << endl;
    cerr << "Output: Generates files in ../generated_packets/graph1/" << endl;
...
int main(int argc, char* argv[]) {
    ...
    cout << "Output directory: ../generated_packets/graph1/" << endl;
    cout << endl;
    
    // Create output directory (Linux/Unix command)
    system("mkdir -p ../generated_packets/graph1");
    ...
    for (int caseNum = 1; caseNum <= numCases; caseNum++) {
        ...
        string filename = "../generated_packets/graph1/graph1_case" + to_string(caseNum) + ".inp";
